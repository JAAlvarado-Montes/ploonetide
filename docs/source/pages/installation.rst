...
.. note::
   ...
   If you're a developer looking to contribute or modify the source code, please refer to the `Developer Guide <developer_guide.rst>` for full setup instructions.
